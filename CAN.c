...
/*
LIBRARY DESCRIPTION:
 * This library allows for the PIC18F46K80 and MCCP2551 CAN hardware node to com-
 * municate with the CAN bus on the CMT '15 vehicle. Primarily it will be linked 
 * with the LINK G4+ ECU CAN bus node. The library functions allow for basic com-
 * munication functionalities such as transmitting, receiving and also initialis-
 * ation of the node itself.
*/
